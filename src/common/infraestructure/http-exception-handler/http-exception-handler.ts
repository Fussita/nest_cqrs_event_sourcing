import {
  ...
  export class HttpExceptionHandler {
    static HandleException(status: number, msg: string, error?: any) {
      switch (status) {
        case 400: return this.BadRequest(msg, error);
        case 403: return this.Forbidden(msg, error)
        case 404: return this.NotFound(msg, error);
        case 500: return this.InternalServerError(msg, error);
        default: return this.InternalServerError(msg, error);
      }
    }
